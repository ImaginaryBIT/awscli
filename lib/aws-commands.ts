...
export const awsServices: Service[] = [
  ...
  },
  {
    ...
    commands: [
      { name: "send-command", description: "Sends a command", parameters: [{ name: "--document-name <value>", description: "Document name" }, { name: "--instance-ids <value>", description: "Instance IDs" }] },
      { name: "get-parameter", description: "Gets a parameter", parameters: [{ name: "--name <value>", description: "Parameter name" }] },
      { name: "put-parameter", description: "Puts a parameter", parameters: [{ name: "--name <value>", description: "Parameter name" }, { name: "--value <value>", description: "Parameter value" }] },
      { name: "list-commands", description: "Lists commands", parameters: [] }
    ]
  },
  {
    name: "cloudwatch",
